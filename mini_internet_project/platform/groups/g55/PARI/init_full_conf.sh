...
vtysh  -c 'conf t' \
 -c 'interface lo' \
 -c 'ip address 55.153.0.1/24' \
 -c 'exit' \
 -c 'interface host' \
 -c 'ip address 55.103.0.2/24' \
 -c 'exit' \
 -c 'router ospf' \
 -c 'network 55.103.0.2/24 area 0' \
 -c 'exit' \
 -c 'router ospf' \
 -c 'ospf router-id 55.153.0.1' \
 -c 'network 55.153.0.1/24 area 0' \
 -c 'exit'\
 ...
 -c 'ip address 55.0.1.2/24' \
 -c 'ip ospf cost 1' \
 -c 'exit' \
 -c 'router ospf' \
 -c 'network 55.0.1.2/24 area 0' \
 -c 'exit' \
 -c 'interface port_GENE' \
 -c 'ip address 55.0.3.1/24' \
 -c 'ip ospf cost 1' \
 -c 'exit' \
 -c 'router ospf' \
 -c 'network 55.0.3.1/24 area 0' \
 -c 'exit' \
 -c 'interface port_LOND' \
 -c 'ip address 55.0.4.1/24' \
 -c 'ip ospf cost 1' \
 -c 'exit' \
 -c 'router ospf' \
 -c 'network 55.0.4.1/24 area 0' \
 -c 'exit' \
 -c 'interface port_NEWY' \
 -c 'ip address 55.0.5.1/24' \
 -c 'ip ospf cost 1' \
 -c 'exit' \
 -c 'router ospf' \
 -c 'network 55.0.5.1/24 area 0' \
 -c 'exit' \
 -c 'interface port_MIAM' \
 -c 'ip address 55.0.6.1/24' \
 -c 'ip ospf cost 1' \
 -c 'exit' \
 -c 'router ospf' \
 -c 'network 55.0.6.1/24 area 0' \
 -c 'exit' \
 -c 'exit' -c 'write' 
