...
vtysh  -c 'conf t' \
 -c 'interface lo' \
 -c 'ip address 55.158.0.1/24' \
 -c 'exit' \
 -c 'interface host' \
 -c 'ip address 55.108.0.2/24' \
 -c 'exit' \
 -c 'router ospf' \
 -c 'network 55.108.0.2/24 area 0' \
 -c 'exit' \
 -c 'router ospf' \
 -c 'ospf router-id 55.158.0.1' \
 -c 'network 55.158.0.1/24 area 0' \
 -c 'exit'\
 ...
 -c 'ip address 55.0.6.2/24' \
 -c 'ip ospf cost 1' \
 -c 'exit' \
 -c 'router ospf' \
 -c 'network 55.0.6.2/24 area 0' \
 -c 'exit' \
 -c 'interface port_GENE' \
 -c 'ip address 55.0.9.2/24' \
 -c 'ip ospf cost 1' \
 -c 'exit' \
 -c 'router ospf' \
 -c 'network 55.0.9.2/24 area 0' \
 -c 'exit' \
 -c 'interface port_NEWY' \
 -c 'ip address 55.0.12.2/24' \
 -c 'ip ospf cost 1' \
 -c 'exit' \
 -c 'router ospf' \
 -c 'network 55.0.12.2/24 area 0' \
 -c 'exit' \
 -c 'interface port_ATLA' \
 -c 'ip address 55.0.13.2/24' \
 -c 'ip ospf cost 1' \
 -c 'exit' \
 -c 'router ospf' \
 -c 'network 55.0.13.2/24 area 0' \
 -c 'exit' \
 -c 'exit' -c 'write' 
